...
def prepare_ocp(
    ...
    # Add objective functions
    objective_functions = ObjectiveList()
    objective_functions.add(ObjectiveFcn.Lagrange.TRACK_CONTROL, key='muscles', target=muscles_ref, weight=50)
    objective_functions.add(ObjectiveFcn.Lagrange.TRACK_STATE, key='q', target=states_ref[:2, :-1], weight=1)
    objective_functions.add(ObjectiveFcn.Lagrange.TRACK_STATE, key='qdot', target=states_ref[2:, :-1], weight=1)
...
if __name__ == '__main__':
    ...
    print(f"***********************")
    print(f"Original tendon SL: {orig_tendon_sl}")
    print(f"Optimized tendon SL: {tendon_sl}")
    print(f"***********************")
    print(f"Original opt len: {orig_opt_len}")
    print(f"Optimized opt len: {opt_len}")
    print(f"***********************")
    print(f"Original fiso max: {orig_fiso_max}")
    print(f"Optimized fiso max: {fiso_max}")
    # sol.animate()
    sol.graphs()
